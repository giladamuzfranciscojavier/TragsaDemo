		...
		contentPanel.setLayout(null);
		{
			...
			okButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if(ProductoController.createUpdateProducto(new Producto(txtNombre.getText(),
							Double.parseDouble(txtPrecio.getText()),dni))) {
						JOptionPane.showMessageDialog(self, "Producto creado con éxito","Éxito", JOptionPane.INFORMATION_MESSAGE);
						self.dispose();
					}
					
					else {
						JOptionPane.showMessageDialog(self, "Error al crear el producto","Error", JOptionPane.WARNING_MESSAGE);
					}
